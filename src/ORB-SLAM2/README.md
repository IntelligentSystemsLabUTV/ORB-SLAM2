...
**DISCLAIMER: This document is a fork of the original ORB-SLAM2 README.md file, with some additions related to the previous fork we made. It has to be updated with new features and changes, and removed functionalities.**

**Authors:** [Raul Mur-Artal](http://webdiis.unizar.es/~raulmur/), [Juan D. Tardos](http://webdiis.unizar.es/~jdtardos/), [J. M. M. Montiel](http://webdiis.unizar.es/~josemari/) and [Dorian Galvez-Lopez](http://doriangalvez.com/) ([DBoW2](https://github.com/dorian3d/DBoW2))

**02 Sep 2020**: Adding QRCode Tracker with wrapped APIs.
...
The library has been also tested on **Ubuntu 18.04** and **Ubuntu 19.10**.
You can run `installDependencies.sh` from your Linux PC to install all the following dependencies.
