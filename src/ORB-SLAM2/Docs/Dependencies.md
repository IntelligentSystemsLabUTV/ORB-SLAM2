...
**DISCLAIMER: This document refers to the original ORB-SLAM2 repository.**
...
The code is from: [here](http://graphics.stanford.edu/~seander/bithacks.html#CountBitsSetParallel).
