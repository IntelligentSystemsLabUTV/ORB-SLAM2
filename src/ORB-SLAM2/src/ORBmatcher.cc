...
int ORBmatcher::SearchByFboW(KeyFrame* pKF,Frame &F, vector<MapPoint*> &vpMapPointMatches)
{
    const vector<MapPoint*> vpMapPointsKF = pKF->GetMapPointMatches();

    vpMapPointMatches = vector<MapPoint*>(F.N,static_cast<MapPoint*>(NULL));

    const fbow::fBow2 &vFeatVecKF = pKF->mFbowFeatVec;
    ...
    fbow::fBow2::const_iterator Fit = F.mFbowFeatVec.begin();
    fbow::fBow2::const_iterator KFend = vFeatVecKF.end();
    fbow::fBow2::const_iterator Fend = F.mFbowFeatVec.end();
    ...
    while(KFit != KFend && Fit != Fend)
    {
        ...
        {
            Fit = F.mFbowFeatVec.lower_bound(KFit->first);
        }
    }
...
int ORBmatcher::SearchByFboW(KeyFrame *pKF1, KeyFrame *pKF2, vector<MapPoint *> &vpMatches12)
{
